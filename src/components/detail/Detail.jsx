...
import PrivacyHelpSection from './privacyHelpSection/PrivacyHelpSection';
...
const Detail = () => {
  ...
  const [backgroundImage, setBackgroundImage] = useState('/bg7.jpeg'); 
  ...
  const clearChatHistory = async () => {
    ...
    try {      
      await updateDoc(chatDocRef, {
        messages: deleteField(), // Removes the entire 'messages' field
      });
      console.log("Chat history cleared");
      setIsClearChatConfirmOpen(false); // Close the confirmation modal after clearing the chat
    } catch (error) {
  ...
  const togglePrivacyHelpSection = () => {
    setIsPrivacyHelpOpen(prevState => !prevState);
  };
  ...
  return (
    <div className='detail'>
      ...
      <div className="info">
        ...
        <div className="option" onClick={togglePrivacyHelpSection}>
          <div className="title">
            <span>Privacy & help</span>
            <img src={isPrivacyHelpOpen ? "./arrowUp.png" : "./arrowDown.png"} alt="Arrow Icon" />
          </div>
          {isPrivacyHelpOpen && (
            <div className="privacy-help-dropdown">
              <PrivacyHelpSection />
            </div>
          )}
        </div>
